---
description: Create a complete Product Requirements Document (PRD) by gathering requirements, running gap analysis, and filling the PRD-Template incrementally across all 22 sections
---

# `/SKILL-01-Create-prd` — PRD Creator
