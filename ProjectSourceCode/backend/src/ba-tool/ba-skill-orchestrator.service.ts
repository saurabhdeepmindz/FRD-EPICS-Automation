...
export class BaSkillOrchestratorService {
  ...
  async executeSkill05ForStory(
    ...
    const focusedPrompt = [
      ...
      'headers. Use the matching example from the skill file (Backend NestJS',
      '/ Frontend Next.js / Database Prisma) based on this SubTask\'s team.',
      '',
      'Frontend (Next.js App Router) example body — copy this shape:',
      '',
      '```text',
      'Project Structure:',
