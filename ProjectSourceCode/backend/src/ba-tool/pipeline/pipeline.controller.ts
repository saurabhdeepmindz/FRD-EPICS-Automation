...
export class PipelineController {
  ...
  @Get('hld/:hldId/technical-view')
  async getHldTechnicalView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getTechnicalView(hldId);
    return { success: true, data };
  }

  @Post('hld/:hldId/technical-view/regenerate')
  async regenerateHldTechnicalView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getTechnicalView(hldId, true);
    return { success: true, data };
  }

  @Get('hld/:hldId/component-view')
  async getHldComponentView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getComponentView(hldId);
    return { success: true, data };
  }

  @Post('hld/:hldId/component-view/regenerate')
  async regenerateHldComponentView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getComponentView(hldId, true);
    return { success: true, data };
  }
  ...
  @Get('hld/:hldId/deployment-view')
  async getHldDeploymentView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getDeploymentView(hldId);
    return { success: true, data };
  }

  @Post('hld/:hldId/deployment-view/regenerate')
  async regenerateHldDeploymentView(@Param('hldId', ParseUUIDPipe) hldId: string) {
    const data = await this.hld.getDeploymentView(hldId, true);
    return { success: true, data };
  }
