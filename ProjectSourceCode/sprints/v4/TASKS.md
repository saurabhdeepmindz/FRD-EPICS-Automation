...
## Status: ✅ Complete — shipped (see WALKTHROUGH.md). 29/30 tasks done; checkboxes reconciled 2026-06-04. Only **Task 28** (P2 unit tests for `BaMasterDataService` + `BaLldParserService`) is deferred — the features shipped and were verified manually.
...
- [x] **Task 1: Add `BaMasterDataEntry`, `BaTemplate`, `BaTemplateModifier`, `BaMasterDataCategory`, `BaMasterDataScope` to Prisma schema** (P0-BE)
...
- [x] **Task 2: Add `lldCompletedAt` and `lldArtifactId` nullable columns on `BaModule`, plus `LLD` variant on `BaArtifactType` enum** (P0-BE)
...
- [x] **Task 3: Seed-data bundle for tech-stack master data (templates NOT bundled)** (P0-BE)
...
- [x] **Task 4: `BaMasterDataService` — CRUD + seed loader + dedupe + promote** (P0-BE)
...
- [x] **Task 5: `BaMasterDataController` — REST endpoints** (P0-BE)
...
- [x] **Task 5b: `BaTemplateUploadController` / endpoint — single-file + folder/zip upload** (P0-BE)
...
- [x] **Task 6: `BaTemplateService` — CRUD + lineage helpers** (P0-BE)
...
- [x] **Task 7: `BaTemplateController` — REST endpoints** (P0-BE)
...
- [x] **Task 8: `ba-api.ts` — types + helpers for master data + templates** (P0-FE)
...
- [x] **Task 9: Architect Console page** (P0-FE)
...
- [x] **Task 10: Templates admin sub-page (inside Architect Console)** (P0-FE)
...
- [x] **Task 11: Link to Architect Console from project header** (P0-FE)
...
- [x] **Task 12: Author `FINAL-SKILL-06-create-lld.md`** (P0)
...
- [x] **Task 13: Register SKILL-06-LLD in orchestrator** (P0-BE)
...
- [x] **Task 14: `assembleSkill06Context()` in orchestrator** (P0-BE)
...
- [x] **Task 15: Post-SKILL-06 parser — `BaLldParserService`** (P0-BE)
...
- [x] **Task 16: `BaLldController` — config + trigger + fetch** (P0-BE)
...
- [x] **Task 17: Hot-wire existing preview / export pipeline for `artifactType === 'LLD'`** (P0-BE)
...
- [x] **Task 18: `ba-api.ts` — types + helpers for LLD config, trigger, artifact, pseudo files** (P0-FE)
...
- [x] **Task 19: Architect LLD Configurator page** (P0-FE)
...
- [x] **Task 20: Module header — LLD button** (P0-FE)
...
- [x] **Task 21: LLD Artifact View** (P0-FE)
...
- [x] **Task 22: Update artifact tree to include LLD artifact** (P0-FE)
...
- [x] **Task 23: Pseudo-file inline editor with AI Suggest + Mic** (P1-FE)
...
- [x] **Task 24: Re-generate preserves human-edited pseudo files** (P1-BE)
...
- [x] **Task 25: RTM slice for LLD linkage** (P1-FE)
...
- [x] **Task 26: LLD Document History integration** (P1-FE)
...
- [x] **Task 27: "Generate Source Code" disabled button** (P1-FE)
...
- [ ] **Task 28: Unit tests for `BaMasterDataService` (Architect Console) + `BaLldParserService`** (P2-BE) — ⬜ **deferred**: feature shipped & verified manually, but these P2 unit tests were never written
...
- [x] **Task 29: Document SKILL-06 in walkthrough + build prompt** (P2)
...
- [x] **Task 30: Regression pass — existing v1/v2/v3 flows unaffected** (P2-QA)
